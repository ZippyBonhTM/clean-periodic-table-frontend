...
Runtime-only server envs such as `AUTH_API_URL`, `BACKEND_API_URL`, and `ADMIN_AUTHZ_SOURCE`
...
If `NEXT_PUBLIC_AUTH_API_URL` or `NEXT_PUBLIC_BACKEND_API_URL` changes, rebuild and repush the image.
